...
For the full Seedance 2 model guide on KIE see [../arcads-external-api/prompting/prompt-library/seedance-2.md](../../arcads-external-api/prompting/prompt-library/seedance-2.md). Claymation-specific rules:
