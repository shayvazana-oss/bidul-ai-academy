...
For the full Seedance 2 model guide on KIE, see [../arcads-external-api/prompting/prompt-library/seedance-2.md](../../arcads-external-api/prompting/prompt-library/seedance-2.md). Key rules for Pixar-style ads:
...
- Total credit estimate must be presented to the user before firing (mandatory per the [KIE SKILL.md credit-cost rule](../../arcads-external-api/SKILL.md#credit-cost-estimation-mandatory--show-before-generating))
